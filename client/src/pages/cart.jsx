...
import ModelSummaryInfo from "../components/main/cart/modelSummaryInfo";
...
const Cart = ({cart, setCart, theme, setTheme, removeToCart}) => {
  ...
  const [modelSummary, setModelSummary] = useState(false)
  ...
  return (
    <>
      <div className={theme ? "theme-dark" : ""}>
        ...
        >
          ...
          <div className="ms-5 col-7 mt-5">
            <div
              className={
                modelSummary
                  ? "row mt-3 table-mobile openModel"
                  : "row mt-3 table-mobile"
              }
            >
            ...
            {cart.length > 0 ? (
              <button
                className={
                  modelSummary ? "btn btn-primary openModel" : "btn btn-primary"
                }
                onClick={() => setModelSummary(true)}
              >
                Check Out
              </button>
            ) : null}
          ...
          {!modelSummary && !show ? (
            ...
            <motion.button
              className="toggle arrow openModelArrow"
              onClick={() => setShow((show) => !show)}
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 1.1 }}
            >
        ...
        {modelSummary ? (
          <ModelSummaryInfo
            setModelSummary={setModelSummary}
