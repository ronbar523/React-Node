...
const Products = ({
  ...
  const categoryName = urlWordsArr[3];
      ...
      <div className="categories-page">
        ...
        <div className="row justify-content-center mt-4">
          ...
          {filter.length > 0 && dataSearch.length > 0 ? (
            ...
            <h3 className="text-center mt-4"> Products Doesn't Found</h3>
          ) : null}
            ...
            <button
              className={
                theme
                  ...
                  : "btn btn-primary d-block py-1 col-12 container bottom-products mb-4"
              }
              disabled={
                noOfElement <= 3 || modelReg || modelInfoOpen || modelDelete
              }
              onClick={() => loadLess()}
            >
              Load Less &nbsp;
        ...
        >
          <motion.div
            className={
              modelReg || modelInfoOpen || modelDelete ? "openModel" : ""
            }
          >
