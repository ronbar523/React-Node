          ...
          <div>
            ...
            <div className="row justify-content-center mt-4">
              ...
              {filter.length > 0 && dataSearch.length > 0 ? (
                ...
                <h3 className="text-center mt-4">Not Products Found</h3>
              ) : null}
              ...
              filter.length === 0 ? (
                <button
                  className={
                    theme
                      ? "btn btn-light d-block py-1 col-12 container mb-1"
                      : "btn btn-primary d-block py-1 col-12 container "
                  }
                  disabled={noOfElement <= 3 || modelInfoOpen}
                  onClick={() => loadLess()}
                >
                  Load Less &nbsp;
