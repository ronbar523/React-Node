        ...
        <div className="text-center ">
          ...
          {!user ? (
            <button
              className={
                modelReg || modelDelete || modelInfoOpen || modelDeleteAll
                  ? "btn btn-secondary ms-2 mb-3 heart openModel"
          ...
          ) : user?._id === item.createdBy && !myProductsPage ? (
            <button
              className={
                modelReg || modelDelete || modelInfoOpen || modelDeleteAll
                  ? "btn btn-danger ms-2 mb-3 heart openModel"
                  : "btn btn-danger ms-2 mb-3 heart"
              }
              disabled={true}
            >
              <FontAwesomeIcon
          ...
          {myProductsPage ? (
            <div>
              <button
                className={
                  modelReg || modelDelete || modelInfoOpen || modelDeleteAll
                    ? "btn btn-outline-danger button-card mt-2 mb-3 openModel"
                    : "btn btn-outline-danger button-card mt-2 mb-3"
                }
              ...
              <Link to={`/products/update/${item._id}`}>
                <button
                  className={
                    modelReg || modelDelete || modelInfoOpen || modelDeleteAll
                      ? "btn btn-outline-warning mt-2 button-card mb-3 ms-2 openModel"
                      : "btn btn-outline-warning mt-2 button-card mb-3 ms-2"
                  }
                >
                  <lord-icon
